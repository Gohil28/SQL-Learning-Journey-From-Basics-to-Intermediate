#Chirag Gohil 
#Linkedin:- https://www.linkedin.com/in/chiraggohil28
...
select * from professionals where Department='Admin';
...
select * from professionals where last_name like "s%l";

#19 Write An SQL Query To Print Details Whose FIRST_NAME Ends With ‘m’ And Contains Six Alphabets 
select * from professionals where First_Name like'_____m';
...
select  min(salary) from Professionals where salary > (select min(salary) from professionals);
...
#24 Write An SQL Query To Fetch Average salary of Department 
...
from professionals group by Department having Average_salary>200000;
...
select * from professionals where Department="Engineer" order by First_Name asc limit 3;
